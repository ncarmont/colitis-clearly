...
export const PRODUCTS: RecommendedProduct[] = [
  ...
  },
  {
    ...
    rankLabel: 'COA page checked — no numbers',
    proofTier: 'Missing numbers',
    purityScore: 43,
    bestFor: 'A proof-quality caution: popular low-acid coffee with a COA-sounding public page, but no comparable public contaminant numbers found in the latest review.',
    description:
      'Lifeboost has a public page titled “Certificate of Analysis” and repeats third-party-testing / 450+ toxin claims. In the reviewed page source, I found marketing claims — not a downloadable numeric COA with lab/date/sample/limits.',
    why:
      'Disclosure check: Lifeboost publicly claims third-party testing for mycotoxins, heavy metals, pesticides, glyphosate, acrylamide, and 450+ toxins. The public “Lifeboost Coffee Certificate of Analysis” page reviewed on 2026-05-20 returned no COA PDF links and no exact lead, cadmium, arsenic, mercury, ochratoxin A, aflatoxin, or reporting-limit table in the fetched page. This does not mean unsafe; it means the public proof is not comparable to exact numeric COAs.',
    ...
    sourceUrl: 'https://lifeboostcoffee.com/products/lifeboost-coffee-certificate-of-analysis',
    sourceLabel: 'COA-titled page reviewed; no numeric table found',
    imageUrl: '/images/coffee-products/lifeboost-grata-medium.png',
    category: 'Watchlist',
    priceRange: '$$–$$$',
    evidenceLevel: 'Emerging',
    effectSize: 'COA page; no values',
    labName: 'Not public on reviewed page',
    reportName: '“Lifeboost Coffee Certificate of Analysis” product page, not a numeric COA PDF',
    reportDate: 'Reviewed 2026-05-20; lab report date not public',
    sample: 'Lifeboost Coffee Certificate of Analysis / Grata Medium Roast context, not batch-specific',
    heavyMetalSummary: 'Claims heavy-metal testing; no public Pb/Cd/As/Hg values or limits found',
    mycotoxinSummary: 'Claims mycotoxin testing; no public OTA/aflatoxin values or limits found',
    moldYeastSummary: 'Claims mold/toxin testing; no public mould/yeast CFU value found',
    testScope: ['Claims heavy metals', 'Claims mycotoxins', 'Claims pesticides', 'Claims glyphosate', 'Claims acrylamide', 'COA-titled page', 'No public numeric table found'],
    scoreBreakdown: [
      { label: 'Heavy metals', value: 8, max: 40, note: 'Testing claimed, but reviewed COA-titled page did not expose Pb/Cd/As/Hg values or reporting limits.' },
      { label: 'Mycotoxins', value: 5, max: 20, note: 'Mycotoxin testing claimed, but no OTA/aflatoxin table was found in the reviewed page.' },
      { label: 'Pesticides', value: 9, max: 15, note: 'Organic/pesticide/glyphosate claims remain useful leads, not public numeric proof.' },
      { label: 'Traceability', value: 7, max: 15, note: 'No lab name, report date, sample ID, batch/lot, or downloadable COA PDF found in the reviewed page.' },
      { label: 'Freshness/value', value: 7, max: 10, note: 'Low-acid/freshness positioning, but clean-coffee price needs public receipts.' },
    ],
    labResults: [
      { label: 'COA-titled page', value: 'Yes' },
      { label: 'Downloadable COA PDF', value: 'Not found' },
      { label: 'Public exact heavy metals', value: 'Not found' },
      { label: 'Public exact mycotoxins', value: 'Not found' },
      { label: 'Reporting limits', value: 'Not public' },
      { label: 'Claims testing', value: '450+ toxins' },
    ],
    disclosureGaps: ['A page named Certificate of Analysis is not enough; buyers need the actual lab report/table.', 'Needs public batch COA with lab name, report date, sample ID, exact lead, cadmium, arsenic, mercury, ochratoxin A, aflatoxins, and reporting limits.', 'This is a proof downgrade, not a claim that the coffee is unsafe.'],
  },
  {
