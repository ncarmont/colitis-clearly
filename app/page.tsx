          ...
          <div className="mt-16">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                Discover where the world's highest polyphenol olive oils are produced
              </p>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-700/50 overflow-hidden">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Greece Region Card */}
                <div className="group relative bg-gradient-to-br from-green-900/40 to-emerald-900/40 rounded-2xl p-6 border-2 border-green-600/30 hover:border-green-500/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20 cursor-pointer">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-400">Koroneiki Capital</p>
                        </div>
                      </div>
                      <div className="px-3 py-1 bg-green-500/20 rounded-full">
                        <span className="text-xs font-bold text-green-300">
                          {OILS_DATA.filter(oil => oil.origin === 'Greece').length} oils
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold text-green-400">
                          {Math.max(...OILS_DATA.filter(oil => oil.origin === 'Greece').map(oil => oil.polyphenols))}
                        </span>
                        <span className="text-xs text-gray-400">mg/kg peak</span>
                      </div>

                      <div className="flex flex-wrap gap-2">
                        {OILS_DATA.filter(oil => oil.origin === 'Greece').slice(0, 3).map(oil => (
                          <div key={oil.id} className="px-2 py-1 bg-gray-800/50 rounded text-xs text-gray-300 border border-gray-700/50">
                            {oil.brand}
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(Math.max(...OILS_DATA.filter(oil => oil.origin === 'Greece').map(oil => oil.polyphenols)) / 2042) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                {/* Jordan Region Card */}
                <div className="group relative bg-gradient-to-br from-amber-900/40 to-orange-900/40 rounded-2xl p-6 border-2 border-amber-600/30 hover:border-amber-500/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/20 cursor-pointer">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <span className="text-4xl">🇯🇴</span>
                        <div>
                          <h3 className="text-xl font-bold text-white">Jordan</h3>
                          <p className="text-sm text-amber-400">Plateau Premium</p>
                        </div>
                      </div>
                      <div className="px-3 py-1 bg-amber-500/20 rounded-full">
                        <span className="text-xs font-bold text-amber-300">
                          {OILS_DATA.filter(oil => oil.origin === 'Jordan').length} oils
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold text-amber-400">
                          {Math.max(...OILS_DATA.filter(oil => oil.origin === 'Jordan').map(oil => oil.polyphenols))}
                        </span>
                        <span className="text-xs text-gray-400">mg/kg peak</span>
                      </div>

                      <div className="flex flex-wrap gap-2">
                        {OILS_DATA.filter(oil => oil.origin === 'Jordan').slice(0, 3).map(oil => (
                          <div key={oil.id} className="px-2 py-1 bg-gray-800/50 rounded text-xs text-gray-300 border border-gray-700/50">
                            {oil.brand}
                          </div>
                        ))}
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(Math.max(...OILS_DATA.filter(oil => oil.origin === 'Jordan').map(oil => oil.polyphenols)) / 2042) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                {/* Spain Region Card */}
                <div className="group relative bg-gradient-to-br from-red-900/40 to-rose-900/40 rounded-2xl p-6 border-2 border-red-600/30 hover:border-red-500/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/20 cursor-pointer">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-400">Picual Power</p>
                        </div>
                      </div>
                      <div className="px-3 py-1 bg-red-500/20 rounded-full">
                        <span className="text-xs font-bold text-red-300">
                          {OILS_DATA.filter(oil => oil.origin === 'Spain').length} oils
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold text-red-400">
                          {Math.max(...OILS_DATA.filter(oil => oil.origin === 'Spain').map(oil => oil.polyphenols))}
                        </span>
                        <span className="text-xs text-gray-400">mg/kg peak</span>
                      </div>

                      <div className="flex flex-wrap gap-2">
                        {OILS_DATA.filter(oil => oil.origin === 'Spain').slice(0, 3).map(oil => (
                          <div key={oil.id} className="px-2 py-1 bg-gray-800/50 rounded text-xs text-gray-300 border border-gray-700/50">
                            {oil.brand}
                          </div>
                        ))}
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(Math.max(...OILS_DATA.filter(oil => oil.origin === 'Spain').map(oil => oil.polyphenols)) / 2042) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                {/* Italy Region Card */}
                <div className="group relative bg-gradient-to-br from-blue-900/40 to-indigo-900/40 rounded-2xl p-6 border-2 border-blue-600/30 hover:border-blue-500/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/20 cursor-pointer">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-400">Tuscan Tradition</p>
                        </div>
                      </div>
                      <div className="px-3 py-1 bg-blue-500/20 rounded-full">
                        <span className="text-xs font-bold text-blue-300">
                          {OILS_DATA.filter(oil => oil.origin === 'Italy').length} oils
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold text-blue-400">
                          {Math.max(...OILS_DATA.filter(oil => oil.origin === 'Italy').map(oil => oil.polyphenols))}
                        </span>
                        <span className="text-xs text-gray-400">mg/kg peak</span>
                      </div>

                      <div className="flex flex-wrap gap-2">
                        {OILS_DATA.filter(oil => oil.origin === 'Italy').slice(0, 3).map(oil => (
                          <div key={oil.id} className="px-2 py-1 bg-gray-800/50 rounded text-xs text-gray-300 border border-gray-700/50">
                            {oil.brand}
                          </div>
                        ))}
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(Math.max(...OILS_DATA.filter(oil => oil.origin === 'Italy').map(oil => oil.polyphenols)) / 2042) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>

                {/* California Region Card */}
                <div className="group relative bg-gradient-to-br from-yellow-900/40 to-amber-900/40 rounded-2xl p-6 border-2 border-yellow-600/30 hover:border-yellow-500/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/20 cursor-pointer">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <span className="text-4xl">🇺🇸</span>
                        <div>
                          <h3 className="text-xl font-bold text-white">California</h3>
                          <p className="text-sm text-yellow-400">New World Quality</p>
                        </div>
                      </div>
                      <div className="px-3 py-1 bg-yellow-500/20 rounded-full">
                        <span className="text-xs font-bold text-yellow-300">
                          {OILS_DATA.filter(oil => oil.origin === 'California').length} oils
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold text-yellow-400">
                          {Math.max(...OILS_DATA.filter(oil => oil.origin === 'California').map(oil => oil.polyphenols))}
                        </span>
                        <span className="text-xs text-gray-400">mg/kg peak</span>
                      </div>

                      <div className="flex flex-wrap gap-2">
                        {OILS_DATA.filter(oil => oil.origin === 'California').slice(0, 3).map(oil => (
                          <div key={oil.id} className="px-2 py-1 bg-gray-800/50 rounded text-xs text-gray-300 border border-gray-700/50">
                            {oil.brand}
                          </div>
                        ))}
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-yellow-600 to-amber-500 rounded-full transition-all duration-1000"
                        style={{ width: `${(Math.max(...OILS_DATA.filter(oil => oil.origin === 'California').map(oil => oil.polyphenols)) / 2042) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                {/* Peru Region Card */}
                <div className="group relative bg-gradient-to-br from-purple-900/40 to-pink-900/40 rounded-2xl p-6 border-2 border-purple-600/30 hover:border-purple-500/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 cursor-pointer">
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <span className="text-4xl">🇵🇪</span>
                        <div>
                          <h3 className="text-xl font-bold text-white">Peru</h3>
                          <p className="text-sm text-purple-400">South American Star</p>
                        </div>
                      </div>
                      <div className="px-3 py-1 bg-purple-500/20 rounded-full">
                        <span className="text-xs font-bold text-purple-300">
                          {OILS_DATA.filter(oil => oil.origin === 'Peru').length} oils
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-baseline gap-2">
                        <span className="text-3xl font-bold text-purple-400">
                          {Math.max(...OILS_DATA.filter(oil => oil.origin === 'Peru').map(oil => oil.polyphenols))}
                        </span>
                        <span className="text-xs text-gray-400">mg/kg peak</span>
                      </div>

                      <div className="flex flex-wrap gap-2">
                        {OILS_DATA.filter(oil => oil.origin === 'Peru').slice(0, 3).map(oil => (
                          <div key={oil.id} className="px-2 py-1 bg-gray-800/50 rounded text-xs text-gray-300 border border-gray-700/50">
                            {oil.brand}
                          </div>
                        ))}
                    ...
                    <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(Math.max(...OILS_DATA.filter(oil => oil.origin === 'Peru').map(oil => oil.polyphenols)) / 2042) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
