...
export const metadata: Metadata = {
  title: 'Privacy Policy | Cleanest Coffee',
  description: 'Privacy policy for Cleanest Coffee.',
}
    ...
    <main className="min-h-screen bg-[#060e1a] text-white">
      <section className="mx-auto max-w-4xl px-4 py-12 md:px-6 md:py-16">
        ...
        <div className="mt-8 space-y-5 text-sm leading-relaxed text-slate-300">
          <p>Cleanest Coffee uses basic analytics and advertising tools to understand site traffic and support the publication.</p>
          ...
          <p>Questions about privacy can be sent to <a className="text-amber-200" href="mailto:contact@thecleanestcoffee.com">contact@thecleanestcoffee.com</a>.</p>
        </div>
      </section>
    </main>
  )
